    ...
    <div className="color-white">
      <article className="mb-10">
        ...
        <p className="color-white text-justify">
          ...
          succeeds in playing You don't have subtitles on your device. Your
          device may not support this type of subtitles.
        </p>
      </article>
      <article className="mb-10">
        <h2 className="color-seven font-semibold text-lg mb-3">
        ...
        <p className="color-white text-justify">
          ...
          to play. Pre-installed players for Windows operating system [VLC
          Player] Depending on your Windows version, download the 32-bit or
          64-bit version. Recommended players for the Android operating system,
          download from Google Play [MX player] [VLC Player] Suggested players
          for iOS operating system download from App Store [VLC For IOS]
          [Oplayer]
        </p>
      </article>
      <article className="mb-10">
      ...
      <article className="mb-10">
        ...
        <p className="color-white text-justify">
          ...
          use different download management apps, such as Document, so that if
          the internet is interrupted, you can use Continue downloading
        </p>
      </article>
      <article className="mb-10">
        <h2 className="color-seven font-semibold text-lg mb-3">
