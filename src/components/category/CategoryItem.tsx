  ...
  return (
    <Link to={`/${item.mal_id}`}>
      <div className="relative rounded-lg overflow-hidden group cursor-pointer">
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-t from-my-black-max flex flex-col justify-end items-center py-3 px-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
          <p className="text-my-white-max font-medium text-sm text-justify line-clamp-4">
            {item.synopsis}
          </p>
          <ul className="text-my-white-max font-medium text-sm text-justify flex gap-x-2 pt-2 line-clamp-4">
