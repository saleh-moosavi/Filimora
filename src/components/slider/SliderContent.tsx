  ...
  return (
    <Link to={`/${id}`}>
      <div className="relative rounded-lg overflow-hidden group">
        ...
        <div className="absolute top-0 bottom-0 left-0 right-0 bg-gradient-to-t from-my-black-max flex justify-center items-end py-3 px-2 opacity-0 group-hover:opacity-100 transition-all duration-300">
