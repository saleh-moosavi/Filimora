...
export default function MobileMenu(props: any) {
  ...
  return (
    <div className="text-white flex justify-center items-center w-full h-full cursor-auto">
      <ul className="bg-gray-100/40 backdrop-blur-md rounded-xl flex flex-col w-96 h-3/4 cursor-auto overflow-y-auto pb-5 *:cursor-pointer border-b-white/50 border-r-white/50 border-b-[3px] border-r-[3px]">
        <li
        ...
        <li
          className="text-gray-300 hover:text-white font-semibold text-lg hover:bg-gray-700 p-5 hover:shadow-[inset_3px_0_0_#fff] hover:ps-8 transition-all duration-500"
        ...
        <li className="self-center bg-gray-800 px-10 py-2 mt-auto rounded-full">
          Sign In
        </li>
      </ul>
    </div>
